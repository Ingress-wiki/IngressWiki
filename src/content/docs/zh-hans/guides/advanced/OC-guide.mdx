...
##### 3.一个Portal是否可能随着时间的推移改变其激活质量，丧失自身的超频能力？
...
##### 6.激活后，Portal在 Lightship的地图上消失了！发生了什么？该怎么办？会在Ingress中消失吗？
...
##### 11.在Portal初始激活后，是否有可能检查扫描统计信息？在Lightship中看不到任何内容，只有状态。
...
### <IWLevel l={3}/>-<IWLevel l={5}/> 三图 (目前统计到 16 种)
